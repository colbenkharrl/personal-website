...
import teamPhoto from '@/app/blog/reflecting-on-spec/spec-team.jpg';
...
<Image src={teamPhoto} alt="image of Spec employees" />
...
<Image src={executivePhoto} alt="image of early Spec executives" />
...
<Image src={familyPhoto} alt="image of Matt, Alex, and Quinn" />
